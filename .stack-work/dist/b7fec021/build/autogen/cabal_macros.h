...
/* package Phys-0.1.0.0 */
#define VERSION_Phys "0.1.0.0"
#define MIN_VERSION_Phys(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "Phys-0.1.0.0-FqDVBlAaeX0HfAo5eLgQw"

#define CURRENT_PACKAGE_KEY "Phys-0.1.0.0-FqDVBlAaeX0HfAo5eLgQw"
